...
final class WhatThisAppDoViewController: UIViewController {
    ...
    private func setupWhatAppCanDoLabel() {
        ...
        whatAppCanDoLabel.text = NSLocalizedString("Onboarding.whatAppCanDo", comment: "")
    ...
    private func setupReceiveRecommendationsLabel() {
        ...
        receiveRecommendationsLabel.text = NSLocalizedString("Onboarding.recommendations", comment: "")
    ...
    private func setupFindMoviesLabel() {
        ...
        findMoviesLabel.text = NSLocalizedString("Onboarding.search", comment: "")
    ...
    private func setupNextButton() {
        ...
        nextButton.alpha = 0
        nextButton.setTitle(NSLocalizedString("Onboarding.confirm", comment: ""), for: .normal)
    ...
    private func setupSaveFilmsLabel() {
        ...
        saveFilmsLabel.text = NSLocalizedString("Onboarding.saveTrips", comment: "")
