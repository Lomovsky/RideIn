...
final class GreetingsOnboardingViewController: UIViewController {
    ...
    private func setupGreetingsLabel() {
        ...
        greetingsLabel.text = NSLocalizedString("Onboarding.greetings", comment: "")
    ...
    private func setupWelcomeLabel() {
        ...
        welcomeLabel.text = "" + NSLocalizedString("Onboarding.welcome", comment: "")
    ...
    private func setupNextButton() {
        ...
        nextButton.setTitle(NSLocalizedString("Onboarding.next", comment: ""), for: .normal)
