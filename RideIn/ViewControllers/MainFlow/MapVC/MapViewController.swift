...
final class MapViewController: UIViewController {
  ...
  private func setupSearchTF() {
    ...
    searchTF.attributedPlaceholder = NSAttributedString(string: NSLocalizedString(.Localization.Map.placeholder, comment: ""),
  ...
  private func setupDistanceLabel() {
    ...
    distanceLabel.text = NSLocalizedString(.Localization.Map.distance, comment: "") + ": " + "\(controllerDataProvider.mapKitDataProvider.distance)" + " " + NSLocalizedString(.Localization.Map.km, comment: "")
