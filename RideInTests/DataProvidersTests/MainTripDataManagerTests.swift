...
class MainTripDataManagerTests: XCTestCase {
  ...
  func testDataDownloading() throws {
    ...
    // when
    sut.downloadDataWith(departureCoordinates: fakeDepartureCoordinates,
                         destinationCoordinates: fakeDestinationCoordinates,
                         seats: fakeSeats, date: nil) { result in
      switch result {
  ...
  func testDataPreparing() throws {
    ...
    let fakeDeparturePlace1 = Place(city: "Kherson",
                                    address: "",
                                    latitude: 46.668396,
                                    longitude: 32.646142,
                                    countryCode: "")
    let fakeDestinationPlace1 = Place(city: "Odessa",
                                      address: "",
                                      latitude: 46.966541,
                                      longitude: 32.000077,
                                      countryCode: "")
    ...
    let fakeDeparturePlace2 = Place(city: "Kherson",
                                    address: "",
                                    latitude: 46.668396,
                                    longitude: 32.646142,
                                    countryCode: "")
    let fakeDestinationPlace2 = Place(city: "Odessa",
                                      address: "",
                                      latitude: 46.966541,
                                      longitude: 32.000077,
                                      countryCode: "")
    ...
    let fakeTrip1 = Trip(link: "fakeTrip1",
                         waypoints: [fakeDepartureWaypoint1, fakeDestinationWaypoint1],
                         price: fakePrice1,
                         vehicle: nil,
                         distanceInMeters: 3000)
    let fakeTrip2 = Trip(link: "fakeTrip2",
                         waypoints: [fakeDepartureWaypoint2, fakeDestinationWaypoint2],
                         price: fakePrice2,
                         vehicle: nil,
                         distanceInMeters: 3000)
    ...
    // when
    do {
      try sut.prepareData(trips: trips, userLocation: fakeUserLocation) { unsorted,
                                                                          cheapToTop,
                                                                          cheapToBottom,
                                                                          cheapest, _ in
        fakeUnsorted = trips
